...
HD_PWD='C:/Work/FPGA/RFSoC-MTS/boards/RFSoC4x2/build_mts/mts/mts.runs/mts_IQ_product_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mts_IQ_product_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mts_IQ_product_0_0.tcl
