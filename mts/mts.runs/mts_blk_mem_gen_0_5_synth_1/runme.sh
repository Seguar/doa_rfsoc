...
HD_PWD='C:/Work/FPGA/RFSoC-MTS/boards/RFSoC4x2/build_mts/mts/mts.runs/mts_blk_mem_gen_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mts_blk_mem_gen_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mts_blk_mem_gen_0_5.tcl
