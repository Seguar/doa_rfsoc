...
# module references:
# uram_play128k, ctrl_snapshot_128k, uram_play128k, ctrl_snapshot_128k, ctrl_snapshot_128k, uram_play128k, ctrl_snapshot_128k, uram_play128k
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins util_ds_buf_2/CLK_IN_D] [get_bd_intf_pins PL_CLK]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins util_ds_buf_3/CLK_IN_D] [get_bd_intf_pins PL_SYSREF]
  connect_bd_intf_net -intf_net s_axi_lite_1 [get_bd_intf_pins s_axi_lite] [get_bd_intf_pins MTSclkwiz/s_axi_lite]

  # Create port connections
  connect_bd_net -net MTSclkwiz_clk_out2 [get_bd_pins MTSclkwiz/clk_out2] [get_bd_pins PSreset_control/slowest_sync_clk] [get_bd_pins clk_out2]
  connect_bd_net -net MTSclkwiz_clk_out3 [get_bd_pins MTSclkwiz/clk_out1] [get_bd_pins ADC_axis_clk] [get_bd_pins DAC_axis_clk] [get_bd_pins RFegressReset/slowest_sync_clk] [get_bd_pins RFingressReset/slowest_sync_clk] [get_bd_pins xpm_cdc_gen_0/dest_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins PSreset_control/peripheral_aresetn] [get_bd_pins s_axi_aresetn] [get_bd_pins RFingressReset/ext_reset_in]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins MTSclkwiz/ref_clk] [get_bd_pins MTSclkwiz/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn1_1 [get_bd_pins s_axi_aresetn1] [get_bd_pins MTSclkwiz/s_axi_aresetn]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins util_ds_buf_0/BUFG_O] [get_bd_pins xpm_cdc_gen_0/src_clk] [get_bd_pins MTSclkwiz/clk_in1]
  connect_bd_net -net util_ds_buf_2_IBUF_OUT [get_bd_pins util_ds_buf_2/IBUF_OUT] [get_bd_pins util_ds_buf_0/BUFG_I]
  connect_bd_net -net util_ds_buf_3_IBUF_OUT [get_bd_pins util_ds_buf_3/IBUF_OUT] [get_bd_pins xpm_cdc_gen_0/src_in]
  connect_bd_net -net xpm_cdc_gen_0_dest_out [get_bd_pins xpm_cdc_gen_0/dest_out] [get_bd_pins UserSYSREF]
...
proc create_hier_cell_control { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 play_out
  create_bd_pin -dir O -from 0 -to 0 capture_out
  create_bd_pin -dir O -from 0 -to 0 Send_Cap
  create_bd_pin -dir O -from 0 -to 0 Send_Play
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins adc_gpio_0/gpio_io_o] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net dac_clk [get_bd_pins pl_adc_clk] [get_bd_pins clk_phase_sync/s_axi_aclk] [get_bd_pins adc_gpio_0/s_axi_aclk] [get_bd_pins dac_gpio/s_axi_aclk]
  connect_bd_net -net dac_gpio_gpio_io_o [get_bd_pins dac_gpio/gpio_io_o] [get_bd_pins play_out] [get_bd_pins Send_Play]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins capture_out] [get_bd_pins Send_Cap]
...
proc create_hier_cell_hier_play3 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net dac_clk [get_bd_pins s_axi_aclk] [get_bd_pins uram_play128k_0/axis_clk] [get_bd_pins axis_broadcaster_0/aclk]
  connect_bd_net -net dac_gpio_gpio_io_o [get_bd_pins enable] [get_bd_pins uram_play128k_0/enable]
  connect_bd_net -net s_axi_aclk1_1 [get_bd_pins s_axi_aclk1] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn1_1 [get_bd_pins s_axi_aresetn1] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins uram_play128k_0/axis_aresetn] [get_bd_pins axis_broadcaster_0/aresetn]
...
proc create_hier_cell_hier_cap3 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net axis_aresetn_1 [get_bd_pins axis_aresetn] [get_bd_pins ctrl_snapshot_128k_0/axis_aresetn] [get_bd_pins axis_combiner_0/aresetn]
  connect_bd_net -net dac_clk [get_bd_pins axis_clk] [get_bd_pins ctrl_snapshot_128k_0/axis_clk] [get_bd_pins axis_combiner_0/aclk]
...
proc create_hier_cell_hier_cap0 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net dac_clk [get_bd_pins axis_clk] [get_bd_pins ctrl_snapshot_128k_0/axis_clk] [get_bd_pins axis_combiner_0/aclk]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axis_aresetn] [get_bd_pins ctrl_snapshot_128k_0/axis_aresetn] [get_bd_pins axis_combiner_0/aresetn]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn]
  connect_bd_net -net trig_cap_1 [get_bd_pins trig_cap] [get_bd_pins ctrl_snapshot_128k_0/trig_cap]
...
proc create_hier_cell_hier_play0 { parentCell nameHier } {
  ...
  connect_bd_net -net dac_clk [get_bd_pins s_axi_aclk] [get_bd_pins uram_play128k_0/axis_clk] [get_bd_pins axis_broadcaster_0/aclk]
  connect_bd_net -net dac_gpio_gpio_io_o [get_bd_pins enable] [get_bd_pins uram_play128k_0/enable]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins uram_play128k_0/axis_aresetn] [get_bd_pins axis_broadcaster_0/aresetn]
  connect_bd_net -net s_axi_aclk1_1 [get_bd_pins s_axi_aclk1] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn1_1 [get_bd_pins s_axi_aresetn1] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set dac1_clk_1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 dac1_clk_1 ]

  set adc2_clk_1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 adc2_clk_1 ]
...
\
  ...
  connect_bd_intf_net -intf_net adc2_clk_1_1 [get_bd_intf_ports adc2_clk_1] [get_bd_intf_pins usp_rf_data_converter_0/adc2_clk]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins clocktreeMTS/s_axi_lite]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins clocktreeMTS/UserSYSREF] [get_bd_pins usp_rf_data_converter_0/user_sysref_adc] [get_bd_pins usp_rf_data_converter_0/user_sysref_dac]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins control/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins clocktreeMTS/s_axi_aclk]
  connect_bd_net -net clocktreeMTS_clk_out2 [get_bd_pins clocktreeMTS/clk_out2] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins hier_cap0/s_axi_aclk] [get_bd_pins hier_cap1/s_axi_aclk] [get_bd_pins hier_cap2/s_axi_aclk] [get_bd_pins hier_cap3/s_axi_aclk] [get_bd_pins hier_play0/s_axi_aclk1] [get_bd_pins hier_play1/s_axi_aclk1] [get_bd_pins hier_play2/s_axi_aclk1] [get_bd_pins hier_play3/s_axi_aclk1] [get_bd_pins axi_smc/aclk]
  connect_bd_net -net clocktreeMTS_interrupt [get_bd_pins clocktreeMTS/interrupt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net clocktreeMTS_s_axi_aresetn [get_bd_pins clocktreeMTS/s_axi_aresetn] [get_bd_pins hier_cap0/s_axi_aresetn] [get_bd_pins hier_cap1/s_axi_aresetn] [get_bd_pins hier_cap2/s_axi_aresetn] [get_bd_pins hier_cap3/s_axi_aresetn] [get_bd_pins hier_play0/s_axi_aresetn1] [get_bd_pins hier_play1/s_axi_aresetn1] [get_bd_pins hier_play2/s_axi_aresetn1] [get_bd_pins hier_play3/s_axi_aresetn1] [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net dac_clk [get_bd_pins clocktreeMTS/ADC_axis_clk] [get_bd_pins hier_play0/s_axi_aclk] [get_bd_pins hier_cap0/axis_clk] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk] [get_bd_pins usp_rf_data_converter_0/m2_axis_aclk] [get_bd_pins usp_rf_data_converter_0/m3_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s2_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s3_axis_aclk] [get_bd_pins hier_cap1/axis_clk] [get_bd_pins hier_cap2/axis_clk] [get_bd_pins hier_cap3/axis_clk] [get_bd_pins hier_play1/s_axi_aclk] [get_bd_pins hier_play2/s_axi_aclk] [get_bd_pins hier_play3/s_axi_aclk] [get_bd_pins control/pl_adc_clk] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins clocktreeMTS/ingress_aresetn] [get_bd_pins hier_play0/s_axi_aresetn] [get_bd_pins hier_cap0/axis_aresetn] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/m1_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/m2_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/m3_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s1_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s2_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s3_axis_aresetn] [get_bd_pins hier_cap1/axis_aresetn] [get_bd_pins hier_cap2/axis_aresetn] [get_bd_pins hier_cap3/axis_aresetn] [get_bd_pins hier_play1/s_axi_aresetn] [get_bd_pins hier_play2/s_axi_aresetn] [get_bd_pins hier_play3/s_axi_aresetn] [get_bd_pins control/s_axi_aresetn1] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn] [get_bd_pins control/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins clocktreeMTS/s_axi_aresetn1]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins clocktreeMTS/ext_reset_in]
