...
#
# doa_mts.tcl: Tcl script for re-creating project 'mts'
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/doa_mts.xdc"]"\
  ]
  foreach ifile $files {
...
set obj [get_filesets sources_1]
set_property -name "top" -value "doa_mts" -objects $obj
...
set file "[file normalize "$origin_dir/doa_mts.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/doa_mts.xdc"
...
# End of cr_bd_mts()
cr_bd_mts ""
set_property REGISTERED_WITH_MANAGER "1" [get_files doa_mts.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files doa_mts.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse doa_mts.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/doa_mts.gen/sources_1/bd/mts/hdl/doa_mts.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse doa_mts.bd] -top]
