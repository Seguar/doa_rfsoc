...
# module references:
# ADCRAMcapture, ADCRAMcapture, DACRAMstreamer, DACRAMstreamer
...
\
  ...
  connect_bd_intf_net -intf_net S00_AXIS_1 [get_bd_intf_pins URAM_prod/S00_AXIS] [get_bd_intf_pins axis_broadcaster_0/M01_AXIS]
  connect_bd_intf_net -intf_net S01_AXIS_1 [get_bd_intf_pins URAM_prod/S01_AXIS] [get_bd_intf_pins axis_broadcaster_1/M01_AXIS]
  connect_bd_intf_net -intf_net S02_AXIS_1 [get_bd_intf_pins URAM_prod/S02_AXIS] [get_bd_intf_pins axis_broadcaster_2/M01_AXIS]
  connect_bd_intf_net -intf_net S03_AXIS_1 [get_bd_intf_pins URAM_prod/S03_AXIS] [get_bd_intf_pins axis_broadcaster_3/M01_AXIS]
  connect_bd_intf_net -intf_net S04_AXIS_1 [get_bd_intf_pins URAM_prod/S04_AXIS] [get_bd_intf_pins axis_broadcaster_4/M01_AXIS]
  connect_bd_intf_net -intf_net S05_AXIS_1 [get_bd_intf_pins URAM_prod/S05_AXIS] [get_bd_intf_pins axis_broadcaster_5/M01_AXIS]
  connect_bd_intf_net -intf_net S06_AXIS_1 [get_bd_intf_pins URAM_prod/S06_AXIS] [get_bd_intf_pins axis_broadcaster_6/M01_AXIS]
  connect_bd_intf_net -intf_net S07_AXIS_1 [get_bd_intf_pins URAM_prod/S07_AXIS] [get_bd_intf_pins axis_broadcaster_7/M01_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins URAM_capture/S00_AXIS] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M00_AXIS [get_bd_intf_pins URAM_capture/S01_AXIS] [get_bd_intf_pins axis_broadcaster_1/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M00_AXIS [get_bd_intf_pins URAM_capture/S02_AXIS] [get_bd_intf_pins axis_broadcaster_2/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M00_AXIS [get_bd_intf_pins URAM_capture/S03_AXIS] [get_bd_intf_pins axis_broadcaster_3/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_4_M00_AXIS [get_bd_intf_pins URAM_capture/S04_AXIS] [get_bd_intf_pins axis_broadcaster_4/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_5_M00_AXIS [get_bd_intf_pins URAM_capture/S05_AXIS] [get_bd_intf_pins axis_broadcaster_5/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_6_M00_AXIS [get_bd_intf_pins URAM_capture/S06_AXIS] [get_bd_intf_pins axis_broadcaster_6/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_7_M00_AXIS [get_bd_intf_pins URAM_capture/S07_AXIS] [get_bd_intf_pins axis_broadcaster_7/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_m00_axis [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_1/m00_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_m01_axis [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_1/m01_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_m02_axis [get_bd_intf_pins axis_broadcaster_2/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_1/m02_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_m03_axis [get_bd_intf_pins axis_broadcaster_3/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_1/m03_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_m20_axis [get_bd_intf_pins axis_broadcaster_4/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_1/m20_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_m21_axis [get_bd_intf_pins axis_broadcaster_5/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_1/m21_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_m22_axis [get_bd_intf_pins axis_broadcaster_6/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_1/m22_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_m23_axis [get_bd_intf_pins axis_broadcaster_7/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_1/m23_axis]
  ...
  connect_bd_net -net clocktreeMTS_clk_out3 [get_bd_pins URAM_capture/aclk] [get_bd_pins URAM_prod/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_broadcaster_2/aclk] [get_bd_pins axis_broadcaster_3/aclk] [get_bd_pins axis_broadcaster_4/aclk] [get_bd_pins axis_broadcaster_5/aclk] [get_bd_pins axis_broadcaster_6/aclk] [get_bd_pins axis_broadcaster_7/aclk] [get_bd_pins clocktreeMTS/ADC_axis_clk] [get_bd_pins usp_rf_data_converter_1/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m1_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m2_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m3_axis_aclk]
  ...
  assign_bd_address -offset 0xA0200000 -range 0x00200000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dac_1/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00200000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dac_0/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0400000 -range 0x00200000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs URAM_capture/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0600000 -range 0x00200000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs URAM_prod/axi_bram_ctrl_0/S_AXI/Mem0] -force
